 ...
 * @param trackId The number of the track or channel on the controller. There are eight tracks, numbered from `1` on the
 * far left to `8` on the far right (1-indexed).
 * @param distanceRotatedClockwise how much the knob was rotated. If it was rotated clockwise, this value will be `1.0`,
 * otherwise, if it was rotated counter-clockwise, this value will be `-1.0`. Turning the knob quickly results in more events
 ...
 * minimum value of `0.0` and a maximum value of `1.0`. For the rotary encoders, this range is shown on the
 * device with 13 LEDs. The seventh LED is in the middle, at the 12 o'clock position, and corresponds to a value of `0.5`.
 */
 ...
 * value of `0.0` and a maximum value of `1.0`. For the faders, this range is shown on the device as -∞ dB to
 * 10 dB, with 0 dB located at about (96/127) ≈ `0.756`.
 */
